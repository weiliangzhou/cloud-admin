...
public interface UserMapper {
    ...
    @Select("select `user_id`, `username`, `password`,`merchant_id`, `email`, `mobile`, `status`, `user_id_create`, `gmt_create`, `gmt_modified`, `name` from sys_user where user_id = #{id}")
    ...
    @Select("select user_id from saas_user where register_mobile=#{phone} and available = 1")
